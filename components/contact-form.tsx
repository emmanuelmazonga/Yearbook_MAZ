...
export function ContactForm() {
  ...
  return <form onSubmit={submit} noValidate className="relative grid gap-6 bg-[#fffdf8] p-7 sm:p-10">
    ...
    <div>
      <label className="flex items-start gap-3 text-sm leading-6"><input required type="checkbox" name="consent" aria-invalid={invalid('consent')} aria-describedby={invalid('consent')?'consent-error':undefined} className="mt-1 size-4 shrink-0 accent-[#701d33]"/><span>I agree that Living Yearbooks may use the information I provide to respond to this enquiry. Read the <Link href="/privacy" className="font-bold text-[#701d33] underline underline-offset-4">privacy notice</Link>.</span></label>

...
type School = {id:string; name:string; city:string; country:string; years:string[]; latest:string; image?:string; href:string; colors:string};
    ...
    <>
      ...
      <div className="mt-10 grid gap-7 md:grid-cols-2 xl:grid-cols-3">
        {visible.map((school, index) => (
          <article key={school.id} className="group overflow-hidden border border-black/12 bg-[#fffdf8]">

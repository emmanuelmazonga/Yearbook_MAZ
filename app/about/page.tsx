...
export default async function AboutPage() {
  ...
  return (
    <main>
      <section className="section-space bg-[#f6f1e7]"><div className="page-shell grid gap-10 lg:grid-cols-[.65fr_1.35fr]"><p className="eyebrow text-[#701d33]">Why we exist</p><div><h1 className="display text-6xl leading-[.93] tracking-[-.05em] sm:text-8xl">School ends.<br />Belonging should not.</h1><p className="mt-8 max-w-3xl text-xl leading-9 text-black/62">Living Yearbooks is a Zambian prototype built around a simple belief: photographs and stories should preserve the texture of school life, not merely prove that it happened. Copperview Secondary is a fictional sample school used to show what a living archive could become.</p><p className="mt-8 border-t border-black/15 pt-6 text-sm font-semibold tracking-wide text-[#701d33]">Emmanuel Mazonga · Creative Lead</p></div></div></section>

  ...
  return (
    <main>
      <section
        ...
        style={{ backgroundImage: "url('/images/hero-class-2026.webp')" }}
      >
        <div className="page-shell relative z-10 flex min-h-[calc(100svh-76px)] items-end pb-12 pt-28 sm:pb-16 lg:items-center lg:py-20">
          <div className="max-w-[760px]">
            <p className="eyebrow reveal text-[#f1ca7e]">Copperview Secondary · Class of 2026</p>
            ...
            <p className="mt-7 max-w-2xl text-base leading-7 text-white/82 sm:text-xl sm:leading-8">
              Beautiful photography, timeless stories, and a living digital yearbook for every graduating class.
            </p>
            <div className="mt-9 flex flex-wrap gap-3">
              <Link href="/yearbooks/copperview-2026" className="focus-ring inline-flex items-center gap-3 bg-[#f6f1e7] px-6 py-4 font-bold text-[#171713] transition hover:bg-[#f1ca7e]">
                Open the 2026 yearbook <ArrowRight className="size-4" />
              </Link>
        ...
        <div className="absolute right-[-1rem] top-[40%] hidden -translate-y-1/2 rotate-90 text-[11px] font-bold uppercase tracking-[.42em] text-white/60 xl:block">This is where our memories live · 2026</div>
      </section>
        ...
        <div className="page-shell grid items-center gap-14 lg:grid-cols-[.88fr_1.12fr]">
          <div>
            ...
            <div className="mt-8 flex items-center gap-5">
              <Link href="/yearbooks/copperview-2026" className="focus-ring inline-flex items-center gap-2 border-b-2 border-[#701d33] pb-2 font-bold text-[#701d33]">Browse Class of 2026 <ArrowRight className="size-4" /></Link>
              <span className="text-sm text-black/45">186 students · 42 stories</span>
            </div>
          </div>
          ...
          <div className="relative mx-auto w-full max-w-[680px] pb-12 pt-4">
            ...
            <article className="cover-shadow grain relative ml-auto aspect-[4/5] w-[72%] overflow-hidden bg-[#701d33] text-white">
              <img src="/images/students-camera-football.webp" alt="Copperview students in the Class of 2026" className="absolute inset-0 h-full w-full object-cover opacity-70 mix-blend-luminosity" />
              ...
              <div className="absolute inset-x-0 top-0 flex items-center justify-between border-b border-white/35 p-5 text-[10px] font-bold uppercase tracking-[.2em]">
                <span>Copperview Secondary</span><span>Kitwe · Zambia</span>
              </div>
              <div className="absolute bottom-0 p-7 sm:p-10">
                <span className="display text-[7rem] leading-none sm:text-[10rem]">26</span>
                <h3 className="display mt-1 text-3xl">The Copper Chapter</h3>
            ...
            <div className="absolute bottom-4 left-0 bg-[#132f31] px-5 py-4 text-white shadow-lg">
              <p className="display text-2xl">Class of 2026</p>
      ...
      <section className="section-space bg-[#e7dcc7]">
        <div className="page-shell">
          <div className="flex flex-col justify-between gap-6 md:flex-row md:items-end">
            ...
            <Link href="/schools/copperview-secondary" className="focus-ring inline-flex items-center gap-2 font-bold text-[#701d33]">Explore the school archive <ArrowRight className="size-4" /></Link>
          </div>
          <div className="mt-14 grid grid-cols-2 gap-4 sm:grid-cols-4">
            {[2026, 2027, 2028, 2029].map((year, index) => (
              <article key={year} className={"group relative aspect-[3/4.2] overflow-hidden p-5 transition hover:-translate-y-2 " + (index === 0 ? "bg-[#701d33] text-white" : index === 1 ? "bg-[#173f42] text-white" : index === 2 ? "bg-[#bd7132] text-white" : "border border-black/20 bg-[#f6f1e7]")}>
                <div className="flex items-center justify-between text-[10px] font-bold uppercase tracking-[.18em] opacity-65"><span>Copperview</span><span>0{index + 1}</span></div>
                <div className="absolute bottom-5 left-5 right-5">
                  <p className="display text-5xl leading-none sm:text-7xl">{String(year).slice(2)}</p>
                  <p className="mt-3 border-t border-current/30 pt-3 text-xs font-bold uppercase tracking-[.18em]">{index === 0 ? "Read now" : "Future class"}</p>
                </div>
              </article>
            ))}
          </div>
      ...
      <section className="grid bg-[#fffdf8] lg:grid-cols-2">
        <div className="min-h-[460px] bg-cover bg-center" style={{ backgroundImage: "url('/images/cultural-day.webp')" }} role="img" aria-label="Students performing at Copperview cultural day" />
        <div className="flex items-center px-6 py-16 sm:px-12 lg:px-[10%]">
          <div className="max-w-xl">
            <Quote className="size-10 text-[#ba6f32]" />
            <blockquote className="display mt-7 text-3xl leading-tight sm:text-5xl">“We thought we were just living ordinary school days. Now they’re the stories we tell first.”</blockquote>
            <p className="mt-7 font-bold text-[#701d33]">— Chanda Mwansa, Class of 2026</p>
            <p className="mt-2 flex items-center gap-2 text-sm text-black/52"><MapPin className="size-4" /> Copperview Secondary School, Kitwe</p>
          </div>
        </div>
      </section>
    </main>
